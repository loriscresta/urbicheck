...
const PAI_COMUNI = {
  ...
  "Calamandrana": { frane: "P0-P1", frane_label: "Assente-basso (Monferrato collinare)", alluvioni: "H0-H1", alluvioni_label: "Assente-trascurabile", note: "Verifica WMS ARPA Piemonte (giugno 2026): nessuna area PAI frane, fasce fluviali o RME rilevata. Monferrato collinare a bassa pericolosità idrogeologica.", link: "https://webgis.arpa.piemonte.it", regione: "Piemonte" },
